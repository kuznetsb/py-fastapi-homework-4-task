...
async def register_user(
    ...
    Args:
        ...
        background_tasks (BackgroundTasks): background tasks processing
        db (AsyncSession): The asynchronous database session.
        email_sender (EmailSenderInterface): The email sender instance.
    ...
    try:
        ...
        login_link = "http://127.0.0.1/activate/"
